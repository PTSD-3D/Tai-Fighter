...
ns.Component.create("chancla", {"shootTime", "shootTimer", "currentHP", "attackMinTime", "attackMaxTime", "attackTimer", "attackTime", "state", "speed"}, {shootTime = 20, shootTimer = 0, currentHP=15, attackMinTime = 100, attackMaxTime = 1000, attackTimer = 0, state = 1, speed = 2}) --state 0 = shooting 1 = attacking 2 = returning
ns.Component.create("chanclaBullet", {"speed","lifetime", "rotation"},{speed=2,lifetime=200,rotation=0})
