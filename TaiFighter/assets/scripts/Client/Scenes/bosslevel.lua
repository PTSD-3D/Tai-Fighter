...
local Scene={
 Entities={	
	BossZone_000=prefabs.BossZone({
		Transform = {position={x=-120,y=0.0,z=0},rotation={x=-0.0,y=450.0001286356067,z=0.0},scale={x=150.0,y=100.0,z=8.304150581359863}}}),
	...
	Player=prefabs.Player({
		Transform = {position={x=-130.0,y=0.0,z=-150.7860107421875},rotation={x=-90.00000250447816,y=90.00000250447816,z=0.0},scale={x=1.0,y=4.599999904632568,z=1.0}}})},
		SceneConfig=
        {
        PhysicsConfig={
            Gravity = 5
