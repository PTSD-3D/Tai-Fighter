...
local Scene={
 Entities={	camera=
	...
	Enemy_001=prefabs.Enemy({
		Transform = {position={x=300.64349365234375,y=-7.999998569488525,z=-82.662384033203125},rotation={x=-90.00000250447816,y=630.0000926634281,z=-0.0},scale={x=3.0,y=3.0,z=3.0}}}),
	...
	Enemy_004=prefabs.Enemy({
		Transform = {position={x=120.64350128173828,y=0.0,z=-53.337615966796875},rotation={x=-90.00000250447816,y=630.0000926634281,z=-0.0},scale={x=3.0,y=3.0,z=3.0}}}),
